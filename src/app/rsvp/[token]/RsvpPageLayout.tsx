...
const PAGE_THEMES: Record<InvitationTheme, PageTheme> = {
  ...
  garden_bloom: {
    pageBg:         '#1a2e18',
    heading:        'rgba(235,245,225,0.96)',
    subtitle:       'rgba(235,245,225,0.72)',
    eyebrow:        'rgba(180,210,160,0.88)',
    infoCardBg:     'rgba(42,78,42,0.40)',
    infoCardBorder: 'rgba(180,210,160,0.22)',
    infoIcon:       'rgba(180,210,160,0.90)',
    infoLabel:      'rgba(180,210,160,0.82)',
    infoValue:      'rgba(235,245,225,0.96)',
    infoAccent:     'rgba(180,210,160,0.96)',
    accent:         '#6a8f58',
    footerText:     'rgba(180,210,160,0.65)',
    footerName:     'rgba(180,210,160,0.88)',
    divider:        'rgba(180,210,160,0.20)',
    noiseOverlay:   false,
  },
  sage_linen: {
    pageBg:         '#222b20',
  ...
  midnight_indigo: {
    ...
    subtitle:       'rgba(220,215,255,0.80)',
    eyebrow:        'rgba(160,150,220,0.90)',
    infoCardBg:     'rgba(14,15,30,0.72)',
    infoCardBorder: 'rgba(160,150,220,0.25)',
    infoIcon:       'rgba(160,150,220,0.90)',
    infoLabel:      'rgba(160,150,220,0.85)',
    infoValue:      'rgba(220,215,255,0.96)',
    infoAccent:     'rgba(160,150,220,0.96)',
    accent:         '#c9964a',
    footerText:     'rgba(160,150,220,0.65)',
    footerName:     'rgba(160,150,220,0.88)',
    divider:        'rgba(160,150,220,0.20)',
    noiseOverlay:   false,
  },
};
