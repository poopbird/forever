...
const PAGE_THEMES: Record<InvitationTheme, PageTheme> = {
  polaroid_white: {
    pageBg:         '#ede8df',
    heading:        'rgba(20,12,5,0.90)',
    subtitle:       'rgba(20,12,5,0.44)',
    eyebrow:        'rgba(160,110,50,0.65)',
    infoCardBg:     'rgba(255,255,255,0.62)',
    infoCardBorder: 'rgba(0,0,0,0.07)',
    infoIcon:       'rgba(160,110,50,0.65)',
    infoLabel:      'rgba(0,0,0,0.42)',
    infoValue:      'rgba(0,0,0,0.84)',
    infoAccent:     'rgba(160,110,50,0.72)',
    accent:         '#c9964a',
    footerText:     'rgba(0,0,0,0.28)',
    footerName:     'rgba(160,110,50,0.62)',
    divider:        'rgba(0,0,0,0.09)',
    noiseOverlay:   false,
  },
  garden_bloom: {
    pageBg:         '#1a2e18',
    heading:        'rgba(235,245,225,0.95)',
    subtitle:       'rgba(235,245,225,0.44)',
    eyebrow:        'rgba(180,210,160,0.55)',
    infoCardBg:     'rgba(42,78,42,0.32)',
    infoCardBorder: 'rgba(180,210,160,0.13)',
    infoIcon:       'rgba(180,210,160,0.68)',
    infoLabel:      'rgba(180,210,160,0.50)',
    infoValue:      'rgba(235,245,225,0.88)',
    infoAccent:     'rgba(180,210,160,0.70)',
    accent:         '#6a8f58',
    footerText:     'rgba(180,210,160,0.38)',
    footerName:     'rgba(180,210,160,0.62)',
    divider:        'rgba(180,210,160,0.12)',
    noiseOverlay:   false,
  },
  sage_linen: {
    pageBg:         '#222b20',
    heading:        'rgba(235,245,225,0.95)',
    subtitle:       'rgba(235,245,225,0.44)',
    eyebrow:        'rgba(180,210,160,0.52)',
    infoCardBg:     'rgba(61,79,59,0.45)',
    infoCardBorder: 'rgba(180,210,160,0.13)',
    infoIcon:       'rgba(180,210,160,0.65)',
    infoLabel:      'rgba(180,210,160,0.48)',
    infoValue:      'rgba(235,245,225,0.88)',
    infoAccent:     'rgba(180,210,160,0.68)',
    accent:         '#7a9268',
    footerText:     'rgba(180,210,160,0.38)',
    footerName:     'rgba(180,210,160,0.60)',
    divider:        'rgba(180,210,160,0.12)',
    noiseOverlay:   true,
  },
  midnight_indigo: {
    pageBg:         '#050714',
    heading:        'rgba(240,235,255,0.96)',
    subtitle:       'rgba(220,215,255,0.48)',
    eyebrow:        'rgba(160,150,220,0.55)',
    infoCardBg:     'rgba(14,15,30,0.70)',
    infoCardBorder: 'rgba(160,150,220,0.15)',
    infoIcon:       'rgba(160,150,220,0.68)',
    infoLabel:      'rgba(160,150,220,0.50)',
    infoValue:      'rgba(220,215,255,0.88)',
    infoAccent:     'rgba(160,150,220,0.72)',
    accent:         '#c9964a',
    footerText:     'rgba(160,150,220,0.38)',
    footerName:     'rgba(160,150,220,0.60)',
    divider:        'rgba(160,150,220,0.12)',
    noiseOverlay:   false,
  },
};
...
export default function RsvpPageLayout({
  ...
  return (
    <>
      {/* Google Fonts */}
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Alex+Brush&family=Cinzel:wght@300;400&family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;1,9..40,300&family=EB+Garamond:ital,wght@0,400;1,400&family=Playfair+Display:ital,wght@0,700;1,700&family=Sorts+Mill+Goudy:ital@0;1&display=swap');
